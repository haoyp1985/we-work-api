<template>
  <div class="app-sidebar">
    ...
    <div class="sidebar-logo">
      ...
      <h2 v-show="sidebarOpened" class="logo-title">WeWork Platform</h2>
    </div>
    ...
    >
      ...
      <!-- 用户管理 -->
      <el-sub-menu index="users" v-if="hasAdminPermission">
        <template #title>
      ...
      <!-- 系统设置 -->
      <el-sub-menu index="settings" v-if="hasAdminPermission">
        <template #title>
          <el-icon><Setting /></el-icon>
          <span>系统设置</span>
        </template>
