  ...
  <div class="home-container">
    ...
    <div class="welcome-section">
      ...
      <div class="welcome-actions">
        ...
        <el-button @click="$router.push('/messages')"> 发送消息 </el-button>
      </div>
    </div>
...
企微账号
        ...
        <el-col :xs="24" :sm="12" :md="6">
          <div class="stat-card">
            ...
            <div class="stat-content">
              <div class="stat-value">
                {{ formatNumber(stats.todayMessages) }}
              </div>
              <div class="stat-label">
今日消息
</div>
      ...
      <div class="activity-list">
        ...
        >
          <div class="activity-icon" :class="activity.type">
            <el-icon v-if="activity.type === 'account'">
              <UserFilled />
            </el-icon>
            <el-icon v-else-if="activity.type === 'message'">
              <ChatDotRound />
            </el-icon>
            <el-icon v-else-if="activity.type === 'alert'">
              <Bell />
            </el-icon>
            <el-icon v-else>
              <InfoFilled />
